...
public class FornecedorDAO implements InterfaceDAO<Fornecedor>{
    ...
    public void create(Fornecedor objeto) {
        ...
        String sqlExecutar = "INSERT INTO fornecedor (cnpj, razaoSocial, inscricaoEstadual, complementoEndereco, email, fone1, fone2, nome, endereco_id, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Fornecedor> retrieve(String parString) {
        ...
        try {
            ...
            rst = pstm.executeQuery();
            while (rst.next()) {
                Fornecedor bairro = new Fornecedor();
                bairro.setId(rst.getInt("id"));
                bairro.setNome(rst.getString("nome"));
                bairro.setCnpj(rst.getString("cnpj"));
                bairro.setRazaoSocial(rst.getString("razaoSocial"));
                bairro.setInscricaoEstadual(rst.getString("inscricaoEstadual"));
                bairro.setFone1(rst.getString("fone1"));
